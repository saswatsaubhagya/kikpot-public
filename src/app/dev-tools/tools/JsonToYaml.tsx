...
export default function JsonToYaml() {
  ...
  return (
    <div className="space-y-6">
      <p className="text-sm text-gray-600 dark:text-gray-400">Simply convert JSON to YAML with this online live converter.</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <section className="p-5 rounded-2xl bg-gray-50/60 dark:bg-gray-900/40 border border-gray-200 dark:border-gray-800 space-y-4">
          <h3 className="font-medium text-gray-900 dark:text-gray-100">YAML from your JSON</h3>
          <textarea
            value={yamlOutput}
            readOnly
          ...
          />
          <div>
            <button onClick={() => copy(yamlOutput)} className="px-4 h-10 rounded-xl border border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 transition-smooth text-white">Copy YAML to clipboard</button>
          </div>
        </section>
      </div>
    </div>
