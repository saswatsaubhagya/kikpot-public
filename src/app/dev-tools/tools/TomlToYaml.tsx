...
export default function TomlToYaml() {
  ...
  return (
    <div className="space-y-6">
      <p className="text-sm text-gray-600 dark:text-gray-400">Parse and convert TOML to YAML.</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <section className="p-5 rounded-2xl bg-gray-50/60 dark:bg-gray-900/40 border border-gray-200 dark:border-gray-800 space-y-4">
          <h3 className="font-medium text-gray-900 dark:text-gray-100">YAML from your TOML</h3>
          <textarea
            value={yamlOutput}
            readOnly
