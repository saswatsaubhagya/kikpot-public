    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        <input
          ...
          className="h-10 px-3 border border-hairline rounded-2xl focus:ring-2 focus:ring-brand/40 focus:border-brand font-mono text-sm text-text bg-surface"
        />
        <input
          value={flags}
      ...
      <div className="p-3 bg-surface-2 border border-hairline rounded-2xl font-mono text-sm text-text">
